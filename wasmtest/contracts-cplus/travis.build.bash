...
docker run -v $(pwd):/root/contracts ontowasm '/bin/bash<<<"mkdir -p /root/contracts; cd /root/contracts; for f in *.cpp; do ont_cpp $f -lbase58 -lcrypto -lbuiltins -o  ${f%.cpp}.wasm; done"'
