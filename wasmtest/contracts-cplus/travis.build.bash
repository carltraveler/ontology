...
docker built -t ontowasm -f Dockerfile
docker run -v $(pwd):/root/contracts ontowasm '/bin/bash<<<"for f in *.cpp; do ont_cpp $f -lbase58 -lcrypto -lbuiltins -o  ${f%.cpp}.wasm; done"'
